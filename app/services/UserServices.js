...
exports.VerifyRegisterService = async (req, res) => {
  try {
...
exports.UpdatePasswordService = async (req, res) => {
  try {
...
exports.ReadProfileService = async (req, res) => {
  try {
    let email = req.headers.email;
...
exports.AllUsersReadProfilesService = async (req, res) => {
  try {
    let email = req.headers.email;
