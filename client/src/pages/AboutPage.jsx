...
function AboutPage() {
  let [tmMembers, setTmMembers] = useState([]);

  useEffect(() => {
    async function fetchTmMembers() {
      try {
        const response = await GetTeamMembers();
        setTmMembers(response.data);
  ...
  return (
    <Layout>
      <section className="bg-gray-100 mb-1.5">
        ...
        <div className="bg-gray-100 h-screen">
          <div className="py-10 max-w-screen-lg mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 justify-center lg:grid-cols-3 col-gap-10">
              {tmMembers.map((member, index) => (
                <div key={index} className="text-center bg-white">
                  <img className="w-100 h-[300px]" src={member["img"]} />
                  <div className="p-4">
